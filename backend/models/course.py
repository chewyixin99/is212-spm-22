...
class Course(db.Model):
    ...
    staffs = db.relationship(
        "Staff", secondary=staff_course, backref="course", viewonly=True
    )
    skills = db.relationship(
        "Skill", secondary=skill_course, backref="course", viewonly=True
    )
    learning_journeys = db.relationship(
        "Learning_Journey",
        secondary=learning_journey_course,
        backref="course",
        viewonly=True,
    )
